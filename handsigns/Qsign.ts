...
qSign.addDirection(Finger.Index, FingerDirection.HorizontalRight, 0.7);

//Middle
qSign.addCurl(Finger.Middle, FingerCurl.FullCurl, 1);
qSign.addDirection(Finger.Middle, FingerDirection.HorizontalRight, 0.7);

//Ring
qSign.addCurl(Finger.Ring, FingerCurl.FullCurl, 1);
qSign.addDirection(Finger.Ring, FingerDirection.DiagonalDownRight, 0.7);

//Pinky
qSign.addCurl(Finger.Pinky, FingerCurl.FullCurl, 1);
qSign.addDirection(Finger.Pinky, FingerDirection.DiagonalDownRight, 0.7);
